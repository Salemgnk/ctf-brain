...
pub fn render(f: &mut Frame, app: &App, form: Option<&EnvVarForm>, area: Rect, box_id: i32) {
    ...
    // Header
    let header = Paragraph::new(format!("🔧 Environment Variables - {}", ctf_box.title))
    ...
    if let Some(form) = form {
        ...
        f.render_widget(Paragraph::new(help).alignment(Alignment::Center), form_chunks[2]);
